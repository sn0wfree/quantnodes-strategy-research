...
TOOL_RESULT_OFFLOAD_THRESHOLD = _env_int(
    "STRATEGY_RESEARCH_TRACE_TOOL_RESULT_INLINE_LIMIT",
    50_000,
)
TRACE_TEXT_OFFLOAD_THRESHOLD = _env_int(
    "STRATEGY_RESEARCH_TRACE_TEXT_INLINE_LIMIT",
    50_000,
)
OFFLOAD_PREVIEW_CHARS = _env_int("STRATEGY_RESEARCH_TRACE_PREVIEW_CHARS", 500)
...
class TraceWriter:
    ...
    def find_trace_dir(
        ...
        Args:
            ...
            runs_dir: Base runs directory. Defaults to ``<strategy_research>/runs``.
            sessions_dir: Base sessions directory. Defaults to
                ``<strategy_research>/sessions``.
