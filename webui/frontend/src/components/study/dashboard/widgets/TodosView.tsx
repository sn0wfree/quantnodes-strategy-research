/**
 * TodosView — fetches and renders todos.md content from API.
 */
...
export function TodosView({ studyId }: WidgetProps) {
  ...
  if (!content) {
    return <div className="text-xs text-slate-500 italic">暂无待办事项</div>
  }
