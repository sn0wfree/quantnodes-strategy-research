/**
 * JournalView — fetches and renders journal.md content from API.
 */
...
export function JournalView({ studyId }: WidgetProps) {
  ...
  if (!content) {
    return <div className="text-xs text-slate-500 italic">暂无研究日志</div>
  }
