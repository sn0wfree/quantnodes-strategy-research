...
from strategy_research.core.hooks import AgentHook, AgentHookContext, CompositeHook
from strategy_research.core.memory import PersistentMemory
from strategy_research.core.session import MetricsLogger, RateLimiter, SessionDB
...
class TestEndToEnd:
    ...
    def test_complete_workflow(self, tmp_path):
        ...
        db.create_session('test_session', workspace=str(tmp_path))
